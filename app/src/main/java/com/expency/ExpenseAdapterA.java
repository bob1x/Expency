    ...
    public class ExpenseAdapterA extends RecyclerView.Adapter<ExpenseAdapterA.ExpenseViewHolder> {

        private MainActivity activity; // Reference to Activity
        private List<Expense> expenseList;
        TextView  expenseDate;  // Add expenseDate


        // Constructor - If the list is null, initialize it to an empty list
        public ExpenseAdapterA(List<Expense> expenseList, MainActivity activity) {
